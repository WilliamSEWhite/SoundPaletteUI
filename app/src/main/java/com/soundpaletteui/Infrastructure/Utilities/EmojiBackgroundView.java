...
public class EmojiBackgroundView extends View {
    ...
    // Stores emoji drawing information
    ...
    // Initializes paint settings and view properties
    private void init() {
    ...
    // Updates the emoji pattern type
    ...
    // Generates the emoji layout based on the selected pattern
    ...
    @Override
    // Draws the emojis and gradient overlay
    ...
    // Generates emojis arranged in a grid
    ...
    // Generates emojis arranged in a spiral pattern
    ...
    // Generates emojis arranged in radial rings
    ...
    // Holds information about each emoji's position and size
